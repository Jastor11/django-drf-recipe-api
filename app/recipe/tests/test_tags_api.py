...
class PublicTagsApiTests(TestCase):
    """Tests the publically available tags API"""
...
class PrivateTagsApiTests(TestCase):
    ...
    def test_retrieve_tags(self):
        ...
        # expect the request to work
        self.assertEqual(res.status_code, status.HTTP_200_OK)
        # expect the data from the request to be the same as
        # taking all the tags and serializing them

...
class PublicUserApiTest(TestCase):
    ...
    def test_password_too_short(self):
        """
        Test that password is at least 6 characters
        """
        payload = {
            'email': 'jeff@astor.io',
            'password': 'pw'
    ...
    def test_create_token_invalid_credentials(self):
        ...
        """
        create_user(email='jeff@astor.io', password='testpassword123')
        payload = {
            'email': 'jeff@astor.io',
    ...
    def test_create_token_no_user(self):
        ...
        """
        payload = {'email': 'jeff@astor.io', 'password': 'testpassword123'}
        res = self.client.post(TOKEN_URL, payload)
